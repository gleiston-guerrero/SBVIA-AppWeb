...
```
- **DOI del software corregido (P4).** `CITATION.cff` declaraba la versión 1.2.0 con el DOI `10.5281/zenodo.22740480`, que **resuelve a la v1.0.1** (14-sep), un depósito anterior que además lista al tercer integrante entre los creadores. Quien siguiera ese identificador descargaba código que no era el evaluado. Se sustituye por el DOI del depósito de la **v1.2.0**, `10.5281/zenodo.22906357`, verificado contra DataCite: título correcto, `version: v1.2.0`, tipo Software, y `IsSupplementTo` apuntando a `github.com/gleiston-guerrero/SBVIA-AppWeb/tree/v1.2.0` — el repositorio de entrega, no un fork.
