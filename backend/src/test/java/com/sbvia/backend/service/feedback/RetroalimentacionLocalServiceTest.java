...
class FeedbackLocalServiceTest {
    ...
    private final FeedbackLocalService motor = new FeedbackLocalService();
    ...
    void conduccionLimpiaDaRiesgoBajoYPuntajeMaximo() {
        FeedbackIaResponse informe = motor.generar(base());
    ...
    void colisionYSemaforoDanRiesgoAlto() {
        ...
        FeedbackIaResponse informe = motor.generar(datos);
