 ...
 */
@Service
public class FeedbackLocalService implements ProveedorFeedback {
    ...
    @Override
    public FeedbackIaResponse generar(DatosConduccion d) {
        ...
        if (aciertos.isEmpty()) aciertos.add("Completó el recorrido del scenario");
    ...
    private String resumen(DatosConduccion d, int total, String riesgo) {
        String base = "Recorrido de " + d.durationSeconds() + " segundos en " + d.nombreEscenario()
