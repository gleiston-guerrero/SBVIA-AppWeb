-- N4 fix: usa ultimo_acceso (campo en User.java L54-55) en lugar de fecha_registro
-- y escribe en bitacora_auditoria (V3/V10) el resultado de la operacion masiva.
