...
\addcontentsline{toc}{section}{Aprobación del documento}

\begin{center}
{\Large\bfseries Especificación de Requisitos de Software}\\[0.2cm]
{\Large\bfseries SBVIA v1.3.0}\\[0.4cm]
Documento sometido a la aprobación del docente-director
\end{center}

\vspace{0.8cm}
\noindent La firma que consta a continuación acredita la \textbf{aprobación del documento}
\texttt{SRS-v1.3.0} por parte del docente-director de la asignatura Aplicaciones Web.
No sustituye a los informes de revisión de versiones anteriores, que declaran
expresamente no constituir aprobación del SRS.
...
\hline
\multicolumn{1}{|c|}{\textbf{Elaborado por}} & \multicolumn{1}{c|}{\textbf{Aprobado por}} \\ \hline
\rule{0pt}{2.6cm} & \rule{0pt}{2.6cm} \\[0.1cm]
\multicolumn{1}{c|}{\rule{6.2cm}{0.4pt}} & \multicolumn{1}{c|}{\rule{6.2cm}{0.4pt}} \\[0.15cm]
\multicolumn{1}{c|}{Justyn Keith Cruz Pérez} & \multicolumn{1}{c|}{Ing. Gleiston Cíceron Guerrero Ulloa} \\[0.1cm]
\multicolumn{1}{c|}{Estudiante, equipo SBVIA} & \multicolumn{1}{c|}{Docente-director, Aplicaciones Web} \\[0.7cm]
\multicolumn{1}{c|}{Fecha: \rule{3.2cm}{0.4pt}} & \multicolumn{1}{c|}{Fecha: \rule{3.2cm}{0.4pt}} \\[0.1cm]
\hline
\end{tabularx}
\end{center}
