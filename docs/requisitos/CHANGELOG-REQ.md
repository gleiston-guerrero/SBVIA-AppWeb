...
| `v1.3.0` | 2026-09-21 | SRS (control del documento) | Cierre | Se abre la v1.3.0 como versión de cierre del examen suspenso, con estado "Pendiente de aprobación". Se alinea el DOI del software con el depósito efectivamente publicado de la v1.2.0 (`10.5281/zenodo.22840356`). |
