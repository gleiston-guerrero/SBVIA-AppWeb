...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{@{}|l|l|X|l|@{}}
        ...
        1.0.0 & 17-09-2026 & Línea base de la entrega final & Sometido a revisión con observaciones, no aprobado \\ \hline
        1.1.0 & 18-09-2026 & Correcciones finales (contrato REST, Lighthouse, URLs y limpieza) & Aprobada --- validada mediante firma del docente-director en el informe de revisión (\texttt{Revision\_SRS\_SBVIA\_v1.1.0.pdf}) según aclaración del 18-09-2026 \\ \hline
    \end{tabularx}
\end{table}

\vspace{0.3cm}
\textit{Nota: el docente-director confirmó el 18-09-2026, por WhatsApp, que su firma en el informe de revisión (\texttt{Revision\_SRS\_SBVIA\_v1.1.0.pdf}) constituye validación suficiente del SRS, sin requerir firma adicional dentro de este documento. Se trata de una aclaración posterior del docente-director, no de una firma directa sobre este documento.}
