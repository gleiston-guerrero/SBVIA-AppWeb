...
\begin{titlepage}
    ...
    \begin{table}[h]
        ...
        \begin{tabularx}{\textwidth}{|l|X|}
            ...
            \textbf{Fecha de emisión} & 19 de septiembre de 2026 \\ \hline
        \end{tabularx}
    \end{table}
...
Ninguna versión figura por tanto como aprobada: las tres constan como revisadas con observaciones.
...
Este documento establece los requisitos verificables de SBVIA v1.2.0 y constituye la línea base contractual para desarrollo, prueba, despliegue y evaluación académica. Esta versión corrige las 14 observaciones (N1–N14) del informe de revisión emitido por el docente-director sobre la v1.1.0 y las 12 observaciones (X1–X12) de su informe de revisión sobre esta misma v1.2.0, además de la observación sobre el expediente de evidencia retractada.
...
\begin{requisito}{RNF-06 - Escala de Usabilidad del Sistema SUS $\ge$ 68 puntos}
    ...
    \textbf{Plan de reevaluación (X12):} El requisito sigue vigente y conserva prioridad \textit{Must}; no se aplaza ni se elimina. Se está ejecutando una nueva evaluación de usabilidad sobre el sistema ya construido, con el fin de sustituir la evidencia retirada por una medición metodológicamente sostenible. No se declara fecha de cierre ni resultados parciales: el instrumento definitivo, los consentimientos verificados y los datos se incorporarán al expediente cuando la reevaluación esté completa. \\[0.2cm]
