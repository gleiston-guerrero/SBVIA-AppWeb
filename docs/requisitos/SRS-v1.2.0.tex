...
\begin{itemize}[label=\textbf{--}]
    ...
    \item \textbf{Anonimización:} Las métricas de evaluación (SUS) se publican únicamente en forma anonimizada con códigos P01–P15.
\end{itemize}
...
Cobertura de pruebas automatizadas: $\geq$ 70\% de líneas (JaCoCo). Puntuación SUS media: 84.17 ($N=15$, DT=8.64). Lighthouse accesibilidad: 0.91 (color-contrast corregido en v1.2.0).
...
\begin{requisito}{RNF-06 - Escala de Usabilidad del Sistema SUS $\ge$ 68 puntos}
    ...
    \textbf{Criterio de aceptación:} La evaluación empírica SUS con al menos 15 participantes alcanza una puntuación media calculada igual o superior a 68. Resultado real: media = 84.17 ($N=15$, IC 95\%: [79.38, 88.95]). \\[0.2cm]
...
\begin{longtable}{|p{1.6cm}|p{4.5cm}|p{3cm}|p{1.5cm}|p{2cm}|}
    ...
    RNF-06 & SUS $\ge$68 & sus-analysis.md & VERIFIED & — \\ \hline
