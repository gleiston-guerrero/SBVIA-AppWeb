...
\begin{titlepage}
    ...
    \begin{table}[h]
        ...
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \textbf{Repositorio canónico (desarrollo)} & \url{https://github.com/keithdrox/SBVIA-AppWeb} \\ \hline
            \textbf{Repositorio de entrega (transferido)} & \url{https://github.com/gleiston-guerrero/SBVIA-AppWeb} \\ \hline
    ...
    \vspace{0.5cm}
    {\small\textit{Nota sobre el repositorio: El repositorio canónico donde se desarrolló el proyecto es
    \texttt{keithdrox/SBVIA-AppWeb}. Por instrucción del docente-director, fue transferido a
    \texttt{gleiston-guerrero/SBVIA-AppWeb} el 18 de septiembre de 2026 como constancia de entrega del
    examen suspenso, dentro del protocolo académico establecido. Esta transferencia no constituye cesión
    de derechos ni autorización de uso de la información fuera del contexto de la evaluación.}}
...
\begin{itemize}[label=\textbf{--}]
    ...
    \item \textbf{AC-04.} Cinco corridas k6 cumplen el umbral de caché caliente (RNF-01); Lighthouse y ZAP conservan evidencia reproducible. La corrida en frío (RNF-02) se añadirá en v1.2.x.
    \item \textbf{AC-05.} El despliegue público dispone de healthcheck, runbook, backup y cuenta demo no administrativa.
    \item \textbf{AC-06.} El repositorio contiene documentación, datos, metadatos y etiqueta v1.1.0 coherentes con el commit declarado. El repositorio de entrega es \texttt{gleiston-guerrero/SBVIA-AppWeb} (ver Nota N14).
\end{itemize}
...
\begin{longtable}{|p{1.6cm}|p{4.5cm}|p{3cm}|p{1.5cm}|p{2cm}|}
    ...
    RNF-06 & SUS $\geq$68 & sus-analysis.md & VERIFIED & — \\ \hline
