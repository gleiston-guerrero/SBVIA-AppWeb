...
\begin{titlepage}
    \centering
    \vspace*{2cm}
    {\large \MakeUppercase{Universidad Técnica Estatal de Quevedo}}\\[1cm]
    
    {\Huge \bfseries Especificación de Requisitos de Software}\\[0.5cm]
    
    {\Large Sistema de Simulación de Comportamiento Vial con Inteligencia Artificial}\\[1.5cm]
    
    {\huge \bfseries \color{uteqblue} SBVIA - Versión 1.0.0}\\[2cm]
    ...
    \begin{table}[h]
        ...
        \begin{tabularx}{0.8\textwidth}{|l|X|}
            \hline
            \textbf{Documento} & SRS conforme a ISO/IEC/IEEE 29148:2018 \\ \hline
            \textbf{Estado} & Línea base para aprobación \\ \hline
            \textbf{Fecha de emisión} & 17 de agosto de 2026 \\ \hline
            \textbf{Repositorio} & github.com/keithdrox/SBVIA-AppWeb \\ \hline
        \end{tabularx}
    \end{table}
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{@{}|X|l|X|l|@{}}
        \hline
        \rowcolor{uteqblue}
        \textcolor{white}{\textbf{Rol}} & \textcolor{white}{\textbf{Nombre}} & \textcolor{white}{\textbf{Firma}} & \textcolor{white}{\textbf{Fecha}} \\ \hline
        Docente-director & Pendiente & \hrulefill & \rule{0.5cm}{0.4pt} / \rule{0.5cm}{0.4pt} / \rule{1cm}{0.4pt} \\ \hline
        Representante del equipo & Pendiente & \hrulefill & \rule{0.5cm}{0.4pt} / \rule{0.5cm}{0.4pt} / \rule{1cm}{0.4pt} \\ \hline
    \end{tabularx}
\end{table}
\textit{\small La firma debe ser incorporada por las personas responsables. Este documento no presume una aprobación que aún no haya ocurrido.}
