...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{@{}|l|l|X|l|@{}}
        ...
        1.0.0 & 17-09-2026 & Línea base de la entrega final & Pendiente de aprobación \\ \hline
    \end{tabularx}
\end{table}
...
\begin{requisito}{RNF-09 - Accesibilidad y Compatibilidad (WCAG 2.2)}
    \textbf{Tipo:} USAB \quad \textbf{Prioridad:} Should \quad \textbf{Estado:} TESTED \\[0.2cm]
    \textbf{Módulo:} Frontend \quad \textbf{Acceso a datos:} No aplica \\[0.2cm]
