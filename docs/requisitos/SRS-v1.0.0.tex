...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{@{}|X|l|X|l|@{}}
        ...
        Docente-director & Ing. Gleiston Cíceron Guerrero Ulloa, Ph.D. & \hrulefill & \rule{0.5cm}{0.4pt} / \rule{0.5cm}{0.4pt} / \rule{1cm}{0.4pt} \\ \hline
        Representante del equipo & Justyn K. Cruz Pérez & \hrulefill & \rule{0.5cm}{0.4pt} / \rule{0.5cm}{0.4pt} / \rule{1cm}{0.4pt} \\ \hline
    \end{tabularx}
\end{table}
