...
Los resultados se clasifican en tres grupos. Se consideran cumplidos el protocolo de cinco corridas calientes, el umbral de latencia, la tasa de error observada, las coberturas de líneas y ramas, los controles funcionales documentados, el despliegue HTTPS verificable y la auditoría Lighthouse en producción (con $91\%$ en Accesibilidad). Se consideran parciales la comparación estadística frío/caliente y la descarga completa de certificado. Permanecen externos al código la firma de aprobación, el video, la defensa y los DOI definitivos.
