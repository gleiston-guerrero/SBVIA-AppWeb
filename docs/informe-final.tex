...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.94\textwidth]{diagramas/Pantalla 1 - Inicio de Sesión Registro.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.94\textwidth]{diagramas/Pantalla 3 - Selección de Escenario (Core).png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.94\textwidth]{diagramas/Pantalla 4 - Reporte de Retroalimentación.png}
