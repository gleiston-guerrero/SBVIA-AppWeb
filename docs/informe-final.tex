...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{diagramas/C4 Nivel 2.png}
\caption{Diagrama C4 de Contenedores. Fuente: Elaboración propia.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{diagramas/Diagrama de clases UML.png}
