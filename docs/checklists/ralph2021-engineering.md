...
| **ER4** | **Evaluación empírica:** El artefacto se evalúa rigurosamente contra requisitos medibles. | ✅ | Pruebas k6 (50 VUs), JaCoCo (>=70%), OWASP y Lighthouse. La evaluación de usabilidad SUS (N=15) se retira (véase `docs/mediciones/sus/sus-analysis.md`). |
...
| **ER6** | **Disponibilidad y Reproducibilidad:** El artefacto y sus datos están disponibles públicamente para replicación. | ✅ | `make all`, datos crudos en `docs/mediciones/`, y despliegue público HTTPS (Render) con 91% en accesibilidad. Solo falta asignar los DOI definitivos en Zenodo. |
