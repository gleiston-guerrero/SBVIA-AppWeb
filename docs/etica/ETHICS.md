...
**Cronología verificable.** Las sesiones se realizaron el **19 y el 20 de septiembre de 2026** sobre el sistema desplegado en `https://sbvia-frontend.onrender.com`. El instrumento se incorporó al repositorio el 2026-09-18 (`786e042`), pero **su redacción en español se revisó el 2026-09-20 a las 18:05** (`b9cac65`) y esa revisión reescribió siete de los diez ítems. En consecuencia, las sesiones del **19 de septiembre** se realizaron con la redacción anterior a esa revisión, y el formulario imprimible que se conserva usa la posterior. Los diez ítems son los del cuestionario SUS estándar de Brooke en ambos casos: cambió la redacción, no el instrumento. **No se sostiene, por tanto, que el instrumento sea anterior a toda sesión**; la diferencia de redacción se declara como limitación. El consentimiento se declara generado el 2026-09-19, y su PDF lleva fecha interna del 2026-09-20 a las 13:03:26, posterior al inicio de las sesiones del 19: ambas fechas se declaran sin conciliarlas.
